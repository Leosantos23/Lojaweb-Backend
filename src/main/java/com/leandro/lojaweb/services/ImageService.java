...
public class ImageService {
	...
	public BufferedImage cropSquare(BufferedImage sourceImg) {
		...
		/*
		 * Descobrir qual e o minimo da imagem, ou seja, a largura ou a altura Usando
		 * uma estrutura de condicao ternaria usando a ? e :
		 */
	...
	/*
	 * Metodo especifico para tratamento de redimensionamento da imagem. Ele vai
	 * receber uma imagem e definir o tamanho que eu quero que ela seja cortada
	 */
