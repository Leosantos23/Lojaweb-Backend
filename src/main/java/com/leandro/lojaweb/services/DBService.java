...
import com.leandro.lojaweb.LojawebApplication;
...
public class DBService {
	...
	public void instanciateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));//Aqui salva todas categorias
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));//Aqui salva todos produtos
